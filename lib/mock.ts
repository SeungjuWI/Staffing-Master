...
export function mockData(): MasterData {
  return {
    ...
    supply: {
      ...
      channels: [
        { key: 'FYI-post', people: 12, applications: 18, docPass: 3, interviews: 0, hires: 0, jobsPosted: null, spendFees: 0, spendAds: 240000, spendKrw: 240000, cpaKrw: 20000, costPerHireKrw: null },
        { key: 'FYI-pre', people: 288, applications: 402, docPass: 74, interviews: 12, hires: 4, jobsPosted: null, spendFees: 0, spendAds: 1800000, spendKrw: 1800000, cpaKrw: 6250, costPerHireKrw: 450000 },
    ...
    matching: {
      ...
      jds: [
        { code: 'FPT401', company: 'FPT Korea', title: 'Backend Developer (Java)', sector: 'it', yoe: '1-3', yoeRaw: '1 - 3', headcount: 5, status: 'Ing', open: true, apps: 214, appsFyi: 0, people: 168, docPass: 44, delivered: 21, interviews: 9, offer: 4, hires: 3, hiresAll: 3, dropped: 0, responded: false, cvSharedAt: '2026-06-02', msSourcing: null, opsCode: null, peopleAll: 168, appsAll: 214, channels: [{ key: 'landing-page', apps: 96 }, { key: 'ITviec-api', apps: 74 }, { key: 'FYI', apps: 28 }, { key: 'top-dev', apps: 16 }], lastAppDate: '2026-07-26', startDate: '2026-05-04', days: 81, curInternal: 38, curNew: 10, curPassed: 20, curReady: 8, curCompany: 8, curInterview: 3, curOffer: 1, health: 'good' },
        { code: 'NX501', company: 'NEXCORE', title: 'Frontend Developer (React)', sector: 'it', yoe: '1-2', yoeRaw: '1-2', headcount: 3, status: 'Ing', open: true, apps: 158, appsFyi: 0, people: 121, docPass: 31, delivered: 16, interviews: 7, offer: 3, hires: 2, hiresAll: 2, dropped: 0, responded: false, cvSharedAt: '2026-06-10', msSourcing: null, opsCode: null, peopleAll: 121, appsAll: 158, channels: [{ key: 'landing-page', apps: 71 }, { key: 'ITviec-api', apps: 52 }, { key: 'LinkedIn', apps: 21 }, { key: 'FYI', apps: 14 }], lastAppDate: '2026-07-27', startDate: '2026-05-11', days: 74, curInternal: 24, curNew: 8, curPassed: 12, curReady: 4, curCompany: 6, curInterview: 2, curOffer: 0, health: 'good' },
        { code: 'WV701', company: 'WaveOn', title: 'Data Engineer', sector: 'it', yoe: '2+', yoeRaw: '2+', headcount: 1, status: 'Ing', open: true, apps: 66, appsFyi: 0, people: 52, docPass: 14, delivered: 0, interviews: 0, offer: 0, hires: 0, hiresAll: 0, dropped: 0, responded: false, cvSharedAt: null, msSourcing: null, opsCode: null, peopleAll: 52, appsAll: 66, channels: [{ key: 'ITviec-api', apps: 38 }, { key: 'landing-page', apps: 20 }, { key: 'jobs-go', apps: 8 }], lastAppDate: '2026-07-20', startDate: '2026-06-15', days: 39, curInternal: 14, curNew: 4, curPassed: 8, curReady: 2, curCompany: 0, curInterview: 0, curOffer: 0, health: 'stall' },
        { code: 'META1303', company: 'MetaSoft', title: 'AI Engineer', sector: 'it', yoe: '3+', yoeRaw: '3+', headcount: 2, status: 'Ing', open: true, apps: 21, appsFyi: 0, people: 17, docPass: 5, delivered: 2, interviews: 0, offer: 0, hires: 0, hiresAll: 0, dropped: 0, responded: false, cvSharedAt: '2026-07-20', msSourcing: null, opsCode: null, peopleAll: 17, appsAll: 21, channels: [{ key: 'landing-page', apps: 12 }, { key: 'FYI', apps: 9 }], lastAppDate: '2026-07-25', startDate: '2026-06-24', days: 30, curInternal: 5, curNew: 2, curPassed: 3, curReady: 0, curCompany: 0, curInterview: 0, curOffer: 0, health: 'low' },
        { code: 'HX801', company: 'HanexSoft', title: 'DevOps Engineer', sector: 'it', yoe: '3-5', yoeRaw: '3-5', headcount: 2, status: 'Ing', open: true, apps: 9, appsFyi: 0, people: 8, docPass: 2, delivered: 0, interviews: 0, offer: 0, hires: 0, hiresAll: 0, dropped: 0, responded: false, cvSharedAt: null, msSourcing: null, opsCode: null, peopleAll: 8, appsAll: 9, channels: [{ key: 'landing-page', apps: 9 }], lastAppDate: '2026-07-27', startDate: '2026-07-23', days: 5, curInternal: 2, curNew: 2, curPassed: 0, curReady: 0, curCompany: 0, curInterview: 0, curOffer: 0, health: 'early' },
        { code: 'LM1001', company: 'LimeMedia', title: 'Fullstack Developer', sector: 'it', yoe: 'intern', yoeRaw: 'Intern', headcount: 2, status: 'Closed', open: false, apps: 176, appsFyi: 0, people: 139, docPass: 35, delivered: 18, interviews: 8, offer: 3, hires: 2, hiresAll: 2, dropped: 0, responded: false, cvSharedAt: '2026-01-15', msSourcing: null, opsCode: null, peopleAll: 139, appsAll: 176, channels: [{ key: 'landing-page', apps: 92 }, { key: 'ITviec-api', apps: 51 }, { key: 'FYI', apps: 33 }], lastAppDate: '2026-06-30', startDate: '2025-11-12', days: 254, curInternal: 0, curNew: 0, curPassed: 0, curReady: 0, curCompany: 0, curInterview: 0, curOffer: 0, health: null },
        { code: 'KD201', company: 'K-Dynamics', title: 'QA Engineer', sector: 'it', yoe: null, yoeRaw: '', headcount: 1, status: 'Closed', open: false, apps: 88, appsFyi: 0, people: 71, docPass: 15, delivered: 8, interviews: 3, offer: 1, hires: 1, hiresAll: 1, dropped: 0, responded: false, cvSharedAt: '2025-10-20', msSourcing: null, opsCode: null, peopleAll: 71, appsAll: 88, channels: [{ key: 'ITviec-api', apps: 60 }, { key: 'landing-page', apps: 28 }], lastAppDate: '2026-05-18', startDate: '2025-09-02', days: 325, curInternal: 0, curNew: 0, curPassed: 0, curReady: 0, curCompany: 0, curInterview: 0, curOffer: 0, health: null },
      ],
      openJds: 5,
      headcountTotal: 13,
      hiresInOpen: 6,
